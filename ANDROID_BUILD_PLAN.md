...
**Minimum Android version:** Android 8.0 (API 26) — covers 95%+ of active devices and ensures all web features work.
...
### Modified files
- `package.json` — New dependencies + Android build scripts
...
- `src/audio/sounds.ts` — Audio context resume on touch
